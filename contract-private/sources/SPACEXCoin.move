module my_addr::SPACEXCoin {
    ...
    const ASSET_SYMBOL: vector<u8> = b"SPACEX";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store::create_primary_store_enabled_fungible_asset(
            constructor_ref,
            option::none(),
            utf8(b"SpaceX Stock Token"),
            utf8(ASSET_SYMBOL),
            6,
            utf8(b"https://logo.clearbit.com/spacex.com"),
            utf8(b"https://spacex.com"),
        );
