module my_addr::STRIPECoin {
    ...
    const ASSET_SYMBOL: vector<u8> = b"STRIPE";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store::create_primary_store_enabled_fungible_asset(
            constructor_ref,
            option::none(),
            utf8(b"Stripe Stock Token"),
            utf8(ASSET_SYMBOL),
            6,
            utf8(b"https://logo.clearbit.com/stripe.com"),
            utf8(b"https://stripe.com"),
        );
