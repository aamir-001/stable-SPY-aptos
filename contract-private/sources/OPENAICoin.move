module my_addr::OPENAICoin {
    ...
    const ASSET_SYMBOL: vector<u8> = b"OPENAI";
    ...
    fun init_module(admin: &signer) {
        ...
        primary_fungible_store::create_primary_store_enabled_fungible_asset(
            constructor_ref,
            option::none(),
            utf8(b"OpenAI Stock Token"),
            utf8(ASSET_SYMBOL),
            6,
            utf8(b"https://logo.clearbit.com/openai.com"),
            utf8(b"https://openai.com"),
        );
